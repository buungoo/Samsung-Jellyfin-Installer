...
|------------|---------------------------------------------------------------------|------------------------------|
| **Stable** | [v2.2.0.0](https://github.com/Jellyfin2Samsung/Samsung-Jellyfin-Installer/releases/tag/v2.2.0.0)                                        | Recommended for most users   |
| **Beta**   | [v2.2.0.1-beta](https://github.com/Jellyfin2Samsung/Samsung-Jellyfin-Installer/releases/tag/v2.2.0.1-beta)                                            | Includes new features        |
